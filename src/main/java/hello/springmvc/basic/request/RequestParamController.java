...
public class RequestParamController {
    ...
    public String requestParamDefault(@RequestParam(required = false, defaultValue = "Lee") String username,
    ...
    public String modelAttributeV2(HelloData helloData) throws Exception{
        log.info("username ={}, age= {}", helloData.getUsername(),helloData.getAge());
